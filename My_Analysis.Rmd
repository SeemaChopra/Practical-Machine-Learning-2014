...
```
Now we are reday to devolp the model on training data and then we will test our model on testing data set. I have tried different model like PCA, KNN and Randomforest. But I found best results from Randomforest.Parameters will be tuned via 5-fold cross validation. I am showing only Randome forest code here, because I helps me to creat fast html file.
...
## KNN Method
## modelfit <- train(classe ~ ., data = training, method = "knn", trControl = cvCtrl)
## Random forest
...
```{r}
#Validation on the testing.CSV file
pred1<-predict(modelfit,data1)
